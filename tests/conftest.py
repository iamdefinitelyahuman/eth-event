...
BASE_LOG = {
    ...
    "blockHash": HexBytes(
        "0xaae58fedb68b648857a24b4a29f3e7f2a905d5098a912562f7ddb895e129b087"
    ),
    "blockNumber": 2,
...
LOGS = [
    (  # BasicTypesEvent
        ...
        [
            HexBytes(
                "0x8be90ba92d3b46c912717b5514ae2cfde5e9acbb5980c2ec5ea937d7586d82ed"
            )
        ],
    ),
    (  # ComplexTypesEvent
        ...
        [
            HexBytes(
                "0x34dee2aae457a1f92adebb1c2acc5ea1acfb088b578a4974c114e8082bf6500f"
            )
        ],
    ),
    (  # FixedLengthArrayEvent
        ...
        [
            HexBytes(
                "0x317cac24adbc0db1e065b9fe727c569313ba08d3e641d73a55955da25c10f1b9"
            )
        ],
    ),
    (  # DynamicArrayEvent
        ...
        [
            HexBytes(
                "0x15bf5b2fd85b349c3ba8e0687fef3f75d19530656850746a30caed288a9d834b"
            )
        ],
    ),
    (  # StructEvent
        ...
        [
            HexBytes(
                "0x2879c8a0baaa8a22a224aed7d8635b7d8e760d16c3f082cd5eba35e9775ab8fc"
            )
        ],
    ),
    (  # IndexedEvent
        ...
        [
            HexBytes(
                "0x7e4de51bd76e0680c76e06c0d5694cb33ce2f8c99b62ba846409bce9014638e0"
            ),
            HexBytes(
                "0x6e12a6379ea806efe7913a2e70ca6b83ef6d457210264b417f34e79bf5a4e2e9"
            ),
            HexBytes(
